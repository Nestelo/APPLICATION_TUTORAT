...
const StudentMessagesScreen = ({ navigation }) => {
  ...
  const [filters] = useState([
    ...
    { id: 'tuteurs', label: 'Tuteurs', icon: 'people-outline' },
  ...
  const loadConversations = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/student/messages/?filter=${selectedFilter}`, {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const url = selectedConversation 
        ? `${API_BASE_URL}/api/student/messages/conversation/${selectedConversation.id}/reply/`
        : `${API_BASE_URL}/api/student/messages/new/`;
  ...
  const markAsRead = async (conversationId) => {
    try {
      const token = await AsyncStorage.getItem('accessToken');
      await fetch(`${API_BASE_URL}/api/student/messages/conversation/${conversationId}/read/`, {
        method: 'POST',
        headers: { 'Authorization': `Bearer ${token}` }
      });
    } catch (error) {
      ...
      [
        { text: 'Annuler', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              const token = await AsyncStorage.getItem('accessToken');
              const response = await fetch(`${API_BASE_URL}/api/student/messages/conversation/${conversation.id}/delete/`, {
                method: 'DELETE',
                headers: { 'Authorization': `Bearer ${token}` }
              });
          ...
          <View style={styles.participantInfo}>
            ...
            <View style={styles.participantDetails}>
              ...
              <Text style={styles.participantRole}>
                {conversation.autre_participant_role === 'tuteur' ? 'Tuteur' : 'Admin'}
              </Text>
            </View>
          </View>
        ...
        <View style={styles.modalBody}>
          {selectedConversation && (
            <View style={styles.replyInfo}>
              ...
              <Text style={styles.replyRole}>
                {selectedConversation.autre_participant_role === 'tuteur' ? 'Tuteur' : 'Admin'}
              </Text>
            </View>
          )}
          ...
          {!selectedConversation && (
            <View style={styles.recipientSection}>
              ...
              <Text style={styles.recipientInput}>Tuteur</Text>
            </View>
          )}
          ...
          <Card style={styles.emptyCard}>
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyText}>
                {searchText ? 'Aucune conversation ne correspond à votre recherche' : 'Commencez une conversation avec vos tuteurs'}
              </Text>
              <Button
